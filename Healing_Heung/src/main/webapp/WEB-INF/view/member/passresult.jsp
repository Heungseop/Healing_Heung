	...
	<div class="form-horizontal">
		<div id="formtogeter">
			<div id="formto">
				...
				<br>
				<br> <img id="result"
					src="<%=request.getContextPath()%>/resources/result.jpg"> <font
					id="font">비밀번호 설정이 완료되었습니다.</font> <img
					src="<%=request.getContextPath()%>/resources/result.jpg"> <br>
				<font id="okfont">다시 메인화면으로 돌아가려면 확인 버튼을 누르세요.<br></font> 
				<br><a href="<%=request.getContextPath()%>/home"><button id="ok">확인</button></a>
			</div>
		</div>
